...
from user.views import  cart,profile, index, registration,editAccount,checkout,logout,deleteCart,myOrder
from user.views import product_desc, saveOrder,shop,login,deleteOrder,compare
from ShopAdmin.views import adminLogin,adminProduct,deleteCat,confirmDelivery ,addCategory ,editCategory ,addProduct,editProduct
from ShopAdmin.views import adminRegister,adminProfile,editAdminAccount,deleteProduct,adminOrder
